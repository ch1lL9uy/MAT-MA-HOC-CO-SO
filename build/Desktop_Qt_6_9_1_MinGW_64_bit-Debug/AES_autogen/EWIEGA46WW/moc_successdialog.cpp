...
template <> constexpr inline auto SuccessDialog::qt_create_metaobjectdata<qt_meta_tag_ZN13SuccessDialogE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SuccessDialog, qt_meta_tag_ZN13SuccessDialogE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject SuccessDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13SuccessDialogE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13SuccessDialogE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13SuccessDialogE_t>.metaTypes,
    nullptr
} };
...
void *SuccessDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13SuccessDialogE_t>.strings))
